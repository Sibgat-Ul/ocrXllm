...
try: 
    ...
    LlamaAttention = None
    print("Warning: LlamaAttention not found. But it's not necessary for DeepSeekV2 model.")

try:
    from transformers.models.llama.modeling_llama import LlamaAttention2
except ImportError:
    LlamaAttention2 = None
    print("Warning: LlamaAttention2 not found. But it's not necessary for DeepSeekV2 model.")
